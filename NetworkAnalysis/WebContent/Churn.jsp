<HTML>
    ...
    <BODY>
        ...
        <FORM ACTION="traffic" METHOD="post">
             <INPUT TYPE="radio" NAME="tfanalysis" VALUE="churn_analysis" onclick="showMe('show-me-churn')"">
             CHURN ANALYSIS
              <div id='show-me-churn' style='display:none'>Enter Locality:<input type="text" id="locality" name="locality" /></div>
            <BR>
            <INPUT TYPE="radio" NAME="tfanalysis" VALUE="customer_churn_analysis" onclick="showMe('show-me')">
             CUSTOMER CHURN ANALYSIS
             <div id='show-me' style='display:none'>Enter Customer Name:<input type="text" id="customername" name="customername" /></div>
            <BR>
            <INPUT TYPE="radio" NAME="tfanalysis" VALUE="MAX_NW_CONSUMPTION" onclick="showMe('show-me-max')">
